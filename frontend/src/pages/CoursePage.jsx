...
const CoursePage = () => {
  ...
  function timeRus(amount, timename) {
    ...
    if (
      problem_of_numerals == 0 ||
      (problem_of_numerals >= 5 && problem_of_numerals <= 9)
    ) {
  ...
  return (
    <main>
      {isLoading ? (
        <Spinner
          className="spinner-grow d-flex m-auto mb-5 mt-5"
          animation="border"
          role="status"
        >
        ...
        <div className="coursePage">
          ...
          <div className="courseInfo">
            ...
            <div className="courseInfo__item">
              ...
              <p className="value">
                {course.course_price +
                  declination(course.course_price, [
                    " рубль",
                    " рубля",
                    " рублей",
                  ])}
          ...
          <div className="document document--null">
            <div className="container">
              ...
              <a
                ...
                href={baseURL + course.course_pdf}
                target="_blank"
              >
                <svg
                  width="30"
          ...
          <div className="document">
            <div className="container">
              <h2>Документ</h2>
              <p>
                {course.document.document_name} при успешном завершении
                обучения.
              </p>
            </div>
          </div>
