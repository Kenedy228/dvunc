    ...
    <main>
      <div className="servicesPage">
        ...
        <div className="serviceBlock serviceProtect">
          <div className="block">
            <h2>
              <span className="orange">Защищаем</span> информацию
            </h2>
            <p>
              Являемся лидерами по защите государственной тайны, персональных
              данных и конфиденциальной информации.
            </p>
          </div>
          {isLoading1 ? (
            <Spinner
              className="spinner-grow d-flex m-auto mb-5"
              animation="border"
              role="status"
            >
        ...
        <div className="serviceBlock serviceDesign">
          <div className="block">
            <h2>
              <span className="orange">Проектируем</span> системы безопасности
            </h2>
            <p>
              Системы охранно-пожарной сигнализации, контроля и управления
              доступом.
            </p>
          </div>
          {isLoading2 ? (
        ...
        <div className="serviceBlock serviceDesign">
          <div className="block">
            <h2>
              <span className="orange">Консультируем</span> по вопросу получения{" "}
              <br /> лицензий ФСБ и ФСТЭК
            </h2>
            <p>
              Осуществляем помощь в подготовке и проверке документов на
              получение лицензии ФСБ и ФСТЭК в любом городе России
            </p>
          </div>
          {isLoading3 ? (
            <Spinner
