            ...
            <Dropdown.Toggle variant="light">
              ...
              <Dropdown.Menu onClick={() => shedule.setSelectedShedule([])}>
                {shedule.courses.map((selected_course) => (
                  <Dropdown.Item
                    onClick={() => shedule.setSelectedCourse(selected_course)}
            ...
            >
              ...
              <Dropdown.Menu>
                {shedule.shedules.map((selected_shedule) => (
                  <Dropdown.Item
                    onClick={() => shedule.setSelectedShedule(selected_shedule)}
        ...
        <tbody>
          {shedule.requests.map((request) => (
            <tr key={request.request_id}>
              ...
              <td>
                {request.request_type === false ? "Физическое" : "Юридическое"}
              </td>
              ...
              <td>
                {request.request_type === false ? (
                  <Button
                    onClick={() =>
                      navigate(
                        RequestADMIN_ROUTE + "/request/" + request.request_id,
                      )
                    }
                    variant="secondary"
                  >
